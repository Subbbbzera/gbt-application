...
function Rent() {
  ...
  const filteredCards = availableCards.filter(card => {
    ...
    const matchSaleType = !card.sale_type || card.sale_type === 'rent' || card.sale_type === 'both';
    ...
    <div className="flex flex-col gap-8 max-w-[1440px] mx-auto px-4 md:px-8 py-10">
      <div className="flex gap-8">
        ...
        <div className="w-1/4 h-fit bg-gray-50 border rounded-2xl p-4 flex-shrink-0 space-y-6 sticky top-28">
          ...
          {}
          <div>
            <h4 className="font-medium mb-2">Ціна за день (грн)</h4>
          ...
          <div className="mb-6 flex justify-between items-center">
            ...
            {priceRange.min || priceRange.max ? (
              <p className="text-sm text-gray-500">
                Ціна: {priceRange.min || "0"} - {priceRange.max || "∞"} грн/день
              </p>
            ) : null}
          </div>
